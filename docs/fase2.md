...
| **12/10/2025** | **`1.3`**  | **Inclusão do GQM — Manutenibilidade (foco em Modificabilidade e Analisabilidade)**      | **[`@fabinsz` - Fábio](https://github.com/fabinsz)** | **[`@Davia Aguiar`](https://github.com/davi-aguiar-vieira)** | **12/10/2025**      |
